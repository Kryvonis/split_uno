...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        KC_TAB,     KC_Q,    KC_W,      KC_E,      KC_R,           KC_T,          KC_WB[[AK,
        KC_LCTL,    KC_A,    KC_S,      KC_D,      KC_F,           KC_G,          MT(MOD_LGUI,KC_LBRC),
        KC_LSFT,    KC_Z,    KC_X,      KC_C,      KC_V,           KC_B,          KC_MUTE,

                             MS_BTN2,   DRAG_SCROLL,        MT(MOD_LALT, KC_BACKSPACE),   KC_SPACE,      LT(_CL,KC_ENT),
                                                            LT(_FL, KC_DEL),              KC_LALT,       KC_LGUI,
        ...
        LT(_FL,MS_BTN1),  KC_DEL, KC_BACKSPACE,  KC_ENT,    MS_BTN1,   MS_BTN2
    ),
    [_FL] = LAYOUT(
        KC_CAPS,    KC_PGUP,   KC_PGDN,     KC_F3,     KC_F4,           KC_F5,         QK_BOOT,
        KC_ESC,     KC_1,      KC_2,        KC_3,      KC_4,            KC_5,          KC_6,
        KC_TAB,     KC_4,      KC_5,        KC_6,      KC_R,            KC_T,          KC_Y,
        KC_LCTL,    KC_7,      KC_8,        KC_9,      KC_0,            KC_G,          KC_LBRC,
        KC_LSFT,    KC_Z,      KC_X,        KC_C,      KC_V,            KC_B,          TG(_FL),

                               MS_BTN2,     MS_BTN1,   KC_DEL,          KC_SPACE,      KC_ENT,
                                                       _______,         KC_RALT,       KC_LGUI,
        ...
        _______,    KC_BACKSPACE,   _______,  KC_ENT,    KC_VOLD,   KC_VOLU
    ),
    [_CL] = LAYOUT(
        KC_CAPS,    KC_PGUP,      KC_PGDN,     KC_F3,     KC_F4,           KC_F5,         QK_BOOT,
        KC_ESC,     KC_1,         KC_2,        KC_3,      KC_4,            KC_5,          KC_6,
        KC_TAB,     KC_4,         KC_5,        KC_6,      KC_R,            KC_T,          KC_Y,
        KC_LCTL,    KC_MUTE,      KC_MPLY,     KC_MPRV,   KC_MNXT,         KC_G,          KC_LBRC,
        KC_LSFT,    KC_Z,         KC_X,        KC_VOLD,   KC_VOLU,         KC_VOLU,       TG(_FL),
