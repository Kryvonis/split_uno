...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        KC_LSFT,    KC_Z,    KC_X,      KC_C,      KC_V,           KC_B,          KC_MUTE,
                             ...
                             KC_WBAK,   DRAG_SCROLL,        MT(MOD_LALT, KC_BACKSPACE),   KC_SPACE,      LT(_CL,KC_ENT),
                                                            LT(_FL, KC_DEL),              KC_LALT,       MT(MOD_LGUI,KC_WBAK),
        ...
        DRAG_SCROLL,  KC_DEL, LT(_CL, KC_BACKSPACE),  LT(_FL,KC_ENT),    MS_BTN1,   MS_BTN2
    ),
    [_FL] = LAYOUT(
